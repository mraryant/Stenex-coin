!(function (n, e) {
  ...
  function s(n, e) {
    ...
    function v(n) {
      ...
      return (
        (t =
          d < 1
            ? Math.exp(-t * d * l) * (1 * Math.cos(p * t) + h * Math.sin(p * t))
            : (1 + h * t) * Math.exp(-t * l)),
        0 === n || 1 === n ? n : 1 - t
      );
    }
  ...
  function B(n, e) {
    return i.dom(n) && !i.inp(n) && (!i.nil(P(n, e)) || (i.svg(n) && n[e]))
      ? "attribute"
      : i.dom(n) && M(t, e)
      ? "transform"
      : i.dom(n) && "transform" !== e && D(n, e)
      ? "css"
      : null != n[e]
      ? "object"
      : void 0;
  ...
  function $(n) {
    ...
    return e.map(function (n, t) {
      return { target: n, id: t, total: e.length, transforms: { list: T(n) } };
    });
  }
  function W(n, e) {
    var t = x(e);
  ...
  function X(n, e) {
    ...
    e))
      i.key(a) && t.push({ name: a, tweens: W(e[a], n) });
    return t;
  }
  var Y = {
    css: function (n, e, t) {
  ...
  function K(t) {
    ...
    function I(n) {
      for (var e = 0, t = M.animations, r = t.length; e < r; ) {
        ...
        for (
          ...
          (b = s.isPath
            ? q(s.value, l * x, s.isPathTargetInsideSVG)
            : w + l * (x - w)),
    ...
    return (
      ...
      (M.play = function () {
        M.paused &&
          (M.completed && M.reset(), (M.paused = !1), _.push(M), C(), R());
      }),
      (M.reverse = function () {
  ...
  return (
    ...
    (K.path = function (n, e) {
      var t = i.str(n) ? g(n)[0] : n,
        r = e || 100;
      return function (n) {
        return { property: n, el: t, svg: j(t), totalLength: L(t) * (r / 100) };
      };
    }),
